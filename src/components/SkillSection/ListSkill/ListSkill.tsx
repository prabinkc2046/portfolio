...
import { PortfolioSectionNavbar, PortfolioSectionNavItem } from '../../../commonStyles/common.styled';
...
export default function ListSkills() {
  ...
  return (
    ...
    <SkillsContainer >
      ...
      {selectedArea === 'All' && isMobile && (
        <ScrollToSomewhere label={'Back to Top'} id={'technical-skills-title'}/>
      )}
